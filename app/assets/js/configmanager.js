...
const dataPath = path.join(sysRoot, '.evimerialauncher')
...
/**
 * Retrieve the cached news articles for offline display.
 *
 * @returns {Array|null} The cached articles array or null.
 */
exports.getNewsCacheArticles = function(){
    return config.newsCache.articles || null
}

/**
 * Set the cached news articles for offline display.
 *
 * @param {Array} articles The articles array to cache.
 */
exports.setNewsCacheArticles = function(articles){
    config.newsCache.articles = articles
}
